...
export default function MainAuthPage() {
  ...
  return (
    <section className="px-4 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <div className="min-h-screen flex fle-col items-center justify-center pb-3 pt-20 px-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
          <div className="mx-auto md:ml-auto">
            <h2 className="hidden sm:block lg:text-5xl text-3xl font-bold lg:leading-[57px] text-slate-900">
              Seamless Adventures for an Exclusive Lifestyle
            </h2>
            <p className="hidden sm:block text-sm mt-6 text-slate-500 leading-relaxed">
